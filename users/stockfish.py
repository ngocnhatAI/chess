...
if __name__ == "__main__":
    board = chess.Board()
    ai = ChessAI(r"C:\Users\pcduc\Downloads\stockfish-windows-x86-64-avx2\stockfish\stockfish-windows-x86-64-avx2.exe")  # Thay đổi đường dẫn tới Stockfish phù hợp
